...
class Command(BaseCommand):
    help = 'Elimina imágenes del sistema de archivos que no están asociadas a ningún objeto ProjectImage'

    def handle(self, *args, **kwargs):
        media_root = settings.MEDIA_ROOT
        image_dir = os.path.join(media_root, 'project_images')
        ...
        referenced_files = set(
            ...
            for img in ProjectImage.objects.exclude(image='')
        )
